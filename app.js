...
function saveProcesses() { /* no-op: data lives in HTML */ }
...
function loadProcCats() {
  procCats = JSON.parse(JSON.stringify(DEFAULT_PROC_CATS));
}

function saveProcCatsData() { /* no-op: data lives in HTML */ }
...
function loadDvCats() {
  dvCats = JSON.parse(JSON.stringify(DEFAULT_DV_CATS));
}

function saveDvCatsData() { /* no-op: data lives in HTML */ }
